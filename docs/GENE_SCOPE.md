...
**Not yet validated against real GeT-RM reference material** — unlike every other v1 gene, no GeT-RM sourcing pass has been done for NUDT15 yet. A real, open item for the next session, not an oversight.
